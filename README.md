...
| `viddy.forCta(...query)`              | as `viddy.for`, but prefers `button` and `anchor` elements                                                                                                                                                                                              |
| `viddy.forInput(...query)`            | as `viddy.for`, but prefers `input` (non-buttons), `select`, and `textarea` elements                                                                                                                                                                    |
...
| `viddy.waitForCta(...query)`          | as `viddy.waitFor`, but prefers `button` and `anchor` elements                                                                                                                                                                                          |
| `viddy.waitForValue(value, ...query)` | Waits for a form `input` (non-buttons), `select`, or `textarea` with the specified value, resolves a Promise with its CSS selector if found                                                                                                             |
